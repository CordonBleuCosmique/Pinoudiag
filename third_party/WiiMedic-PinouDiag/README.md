> **Ceci est un fork.** Ce dossier est une version modifiée de
> [WiiMedic](https://github.com/PowFPS1/WiiMedic) par **PowFPS1**, adaptée
> pour être lancée comme addon de diagnostic par
> [PinouDiag](https://github.com/CordonBleuCosmique/Pinoudiag). Ce n'est
> **pas** la release officielle de PowFPS1. Voir `CHANGES.md` dans ce
> dossier pour la liste exacte des modifications, et `docs/licensing.md`
> dans le dépôt PinouDiag pour les obligations GPLv2 associées. Le reste de
> ce README est le README original de WiiMedic, inchangé.
