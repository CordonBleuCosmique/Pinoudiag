...
Premier programme de test du projet **Pinoudiag** pour Nintendo DS.
...
Cela génère `pinouNDSdiag.nds` à la racine de ce dossier.

## Test

- Sur un flashcart / carte SD (R4, ez-flash, TWiLight Menu++...) : copier
  `pinouNDSdiag.nds` sur la carte et le lancer depuis le menu de la console.
...
- Test visuel complet des deux écrans (mires de couleur, pas seulement le
  texte de la console)
- Test des boutons et de la croix directionnelle (cf. `../pinouNDSdiag/boutons/`)
- Test audio (haut-parleurs / prise casque)
- Test tactile (écran bas)
- Menu de sélection entre les différents tests
